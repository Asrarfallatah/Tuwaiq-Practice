...
public class MerchantStockController {
    ...
    public ResponseEntity<?> getMerchantStocks(){
        ...
        if (merchantStockService.getMerchantStocksRepository().isEmpty()){
        ...
        return ResponseEntity.status(200).body(merchantStockService.getMerchantStocksRepository());
    }
    ...
    public ResponseEntity<?> updateMerchantStock(@PathVariable Integer merchantStockID , @Valid @RequestBody MerchantStock merchantStock , Errors errors){
